...
import { 
  ...
  Percent, CheckSquare, AlertCircle, Clock, Activity, BarChart3, FileCheck, FileSpreadsheet
} from 'lucide-react';
            ...
            {feedbackSuccess ? (
              ...
              <form onSubmit={handleFeedbackSubmit} className="space-y-4">
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 font-bold uppercase mt-0.5 tracking-wider">Help Us Refine Operon</p>
                </div>
