          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="bg-white border border-slate-100 p-6 rounded-3xl shadow-sm space-y-4">
              <div className="flex justify-between items-center border-b border-slate-50 pb-2">
                ...
                <a href="/dashboard/reports" className="text-[10px] font-black text-blue-600 hover:underline">View Official Sheet →</a>
              </div>
              <p className="text-[11px] text-slate-400 font-semibold leading-relaxed">
                Report cards generated by subject teachers are aggregated into standard PDF/Web formats under the Reports page. Access the navigation bar to preview published evaluations.
              </p>
            </div>
                ...
                <div className="lg:col-span-8 space-y-6">
                  ...
                  <div className="bg-white border border-slate-100 p-6 rounded-3xl shadow-sm space-y-4">
                    <div className="flex justify-between items-center border-b border-slate-50 pb-2">
                      ...
                      <a href="/dashboard/reports" className="text-[10px] font-black text-blue-600 hover:underline">Access Official Grade Cards →</a>
                    </div>
                    <p className="text-[11px] text-slate-400 font-semibold leading-relaxed">
                      You are linked directly to {kid.firstName}'s term grades and progress indicators. Access the Reports tab to download and save copies of authorized sheets.
                    </p>
                  </div>
