...
export default function TeachersDirectoryPage() {
  ...
  const downloadTemplate = () => {
    ...
    XLSX.utils.book_append_sheet(wb, wsSheet, 'TeachersTemplate');
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="bg-white border border-slate-100 rounded-3xl shadow-sm p-6 space-y-4">
        ...
        {/* Batch Actions Bar */}
        {selectedTeacherIds.length > 0 && isAdmin && (
          <div className="flex items-center justify-between bg-white border border-slate-200 rounded-2xl px-5 py-3 mb-4 shadow-sm transition-all duration-300">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xs font-extrabold text-slate-800 font-sans">
                Selected <span className="text-blue-600 font-black text-sm px-0.5">{selectedTeacherIds.length}</span> teachers
              </span>
            </div>
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1.5 !bg-blue-600 !border-blue-600 !text-white px-4 py-2 rounded-xl text-xs font-black transition-all cursor-pointer shadow-sm font-sans active:scale-95 hover:!bg-blue-500 hover:!border-blue-500"
              >
              ...
              <button
                ...
                className="flex items-center gap-1.5 !bg-red-600 !border-red-600 !text-white px-4 py-2 rounded-xl text-xs font-black transition-all cursor-pointer shadow-sm font-sans active:scale-95 hover:!bg-red-500 hover:!border-red-500"
              >
            ...
            <table className="w-full border-collapse text-left text-xs font-semibold text-slate-600">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-100 text-[10px] font-black uppercase tracking-wider text-slate-400">
                  ...
                  <th className="p-4 font-black text-slate-800">Teacher Name</th>
                  <th className="p-4">Email Address</th>
                  <th className="p-4">Phone Contact</th>
                  <th className="p-4">Cleared Role</th>
                  <th className="p-4 text-center">Status</th>
                  <th className="p-4 text-center">{isAdmin ? 'Actions' : 'Details'}</th>
                </tr>
              </thead>
